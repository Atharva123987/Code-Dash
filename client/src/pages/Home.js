...
<section class="home-body  body-font">
  <div class="container px-5 py-24 mx-auto">
    ...
    <div class="flex  lg:w-2/3 w-full sm:flex-row flex-col mx-auto px-8 sm:space-x-4 sm:space-y-0 space-y-4 sm:px-0 items-end">
      <button class="text-black bg-white border-0 py-2 px-8 focus:outline-none hover:bg-slate-300 transition-all active:bg-slate-600 active:text-white rounded text-lg"><FcGoogle/>Sign in with Google</button>
